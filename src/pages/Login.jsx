...
// if error case return error
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-base-200 dark:bg-gray-900 transition duration-300"> {/* Added bg for contrast */}
      <div className="card w-96 bg-base-100 shadow-xl dark:bg-gray-800 dark:border-gray-700">
